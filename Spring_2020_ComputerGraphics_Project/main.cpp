...
void DimLines(){
 ...
 void car2(){
	...
	GLfloat x=0.60f; GLfloat y=-0.956f; GLfloat radius =0.012f;
	int triangleAmount = 20; //# of triangles used to draw circle
	...
	GLfloat x1=0.81f; GLfloat y1=-0.956f; GLfloat radius1 =0.012f;
...
void keyboard(unsigned char key, int x, int y)
{
 ...
 void display(){
     ...
     glutTimerFunc(10000,display3,0);
      ...
      glutTimerFunc(20000,display1,0);

      glutTimerFunc(25000,display2,0);

      glutTimerFunc(30000,display3,0);

      glutTimerFunc(35000,display4,0);

      glutTimerFunc(40000,display1,0);

      glutTimerFunc(45000,display2,0);

      glutTimerFunc(50000,display3,0);

      glutTimerFunc(55000,display4,0);

      glutTimerFunc(60000,display1,0);

      glutTimerFunc(65000,display2,0);

      glutTimerFunc(70000,display3,0);

      glutTimerFunc(75000,display4,0);
